 ...
 * created by this factory sends a bogus certificate defined in {@link HttpsServerKeyStore}.
 * <p>
 ...
 */
public class HttpsServerSslContextFactory
{
    ...
    static
	{
        ...
        try
		{
            ...
            ks.load(HttpsServerKeyStore.asInputStream(),
                    HttpsServerKeyStore.getKeyStorePassword());

            // Set up key manager factory to use our key store
            KeyManagerFactory kmf = KeyManagerFactory.getInstance(algorithm);
            kmf.init(ks, HttpsServerKeyStore.getCertificatePassword());
        ...
        try
		{
            ...
            clientContext.init(null, HttpsServerTrustManagerFactory.getTrustManagers(), null);
        }
		catch (Exception e)
		{
